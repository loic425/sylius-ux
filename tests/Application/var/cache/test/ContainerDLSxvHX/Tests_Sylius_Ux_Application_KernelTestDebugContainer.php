 ...
 */
class Tests_Sylius_Ux_Application_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'Tests\\Sylius\\Ux\\Application\\Kernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/Tests_Sylius_Ux_Application_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'UxBundle' => 'Sylius\\Ux\\Core\\Symfony\\Bundle\\UxBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'UxBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/src/Core/Symfony/Bundle'),
                    'namespace' => 'Sylius\\Ux\\Core\\Symfony\\Bundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Tests_Sylius_Ux_Application_KernelTestDebugContainer',
